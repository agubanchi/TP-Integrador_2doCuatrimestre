...
var Cartas = /** @class */ (function () {
    ...
    Cartas.prototype.iniciarJuego = function () {
        ...
        var apuesta = readlineSync.questionInt("Ingrese su apuesta: ");
        this.apostar(apuesta);
        var resultado = this.validarGanador();
...
var juego = new Cartas("El mazaso", this.player);
juego.iniciarJuego();
