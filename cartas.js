...
var Cartas = /** @class */ (function () {
    ...
    Cartas.prototype.probabilidades = function () {
        var probabilidades = " -----------------------------------------------------------------------------------------------------En este juego, hay 27 cartas posibles (números del 1 al 9, y tres colores: rojo, blanco y negro). La probabilidad de que el jugador obtenga una carta específica depende del número total de cartas y de cuántas cartas hay de ese tipo específico.";
